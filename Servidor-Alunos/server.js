...
app.get('/download', (_req, res) => {
    const file = path.join(__dirname, 'public/arquivos/CY4/Projeto_Arrecadacao.zip');
    res.download(file, 'Projeto_Arrecadacao.zip'); //"res.download" força o navegador a baixar
});
